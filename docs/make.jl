...
makedocs(
    ...
    format = Documenter.HTML(
        ...
        canonical = "https://statistical-network-analysis-with-Julia.github.io/ERGMRank.jl/dev/",
    ...
    repo = Documenter.Remotes.GitHub("Statistical-network-analysis-with-Julia", "ERGMRank.jl"),
    pages = [
        "Home" => "index.md",
